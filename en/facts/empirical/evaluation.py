...
# Expected hit rates (example values, please adjust or determine dynamically if needed)
expected_hit_rates = {
    1: 0.01,
    0.5: 0.005,
    2/3: 0.006,
...
for eps in epsilons:
    ...
    for delta in deltas:
        ...
        # You can use background_rate instead of expected_hit_rates[eps] if there is no theoretical rate
