...
def evolve_rft_pure(
    ...
    """Time evolution of a pure state with RFT dynamics.
...
def evolve_standard_pure(
    ...
    """Standard QM time evolution (linear, λ=0)."""
    psi = psi0.copy()
...
def main() -> int:
    ...
    # ─── Header ───────────────────────────────────────────────────────
    print("=" * 74)
    print("  2-particle RFT: Gisin theorem and no-signaling analysis")
    print("  Question: Does the RFT feedback violate the no-signaling")
    print("  condition in the multi-particle sector?")
    print("=" * 74)
