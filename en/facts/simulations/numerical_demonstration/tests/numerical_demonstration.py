...
Demonstrates the consistency of resonance energy (Lorentz profile),
coupling efficiency and resonance entropy over the (A, τ) parameter space.

This simulation is not a proof of Resonance Field Theory, but a
numerical demonstration of the internal consistency of Axioms
A3–A5. Empirical validation is performed separately via the
Monte Carlo analysis with independent data.
...
def berechne_kopplungseffizienz(
    ...
    """Coupling efficiency from the resonance profile (Axiom A4).
...
def plot_numerische_demonstration(
    ...
    fig.canvas.manager.set_window_title(
        'Resonance Field Theory — Numerical Demonstration (A3, A4, A5)')
    ...
    ax1.set_title(
        r"Resonance energy $E_{\mathrm{res}}$"
...
if __name__ == "__main__":
    ...
    # Console output
    print("Resonance Field Theory — Numerical Demonstration")
    print("=" * 50)
    ...
    print(f"S_max at ε = 1/e ≈ {1/np.e:.4f}: "
          f"S = {1/np.e:.4f}")
    print()
    print("Note: This is a numerical demonstration")
    print("of axiom consistency, not an empirical proof.")
    print("For empirical validation see the Monte Carlo analysis.")
    print("=" * 50)
