...
\begin{document}
	...
	empirical validation, open science
	...
	through cosmology and nuclear technology.
	...
	RFT is tested across three independent domains:
	particle physics (Section~\ref{sec:monte_carlo}),
	cosmology (Section~\ref{sec:flrw}),
	and nuclear technology (Section~\ref{sec:resonanzreaktor}).
