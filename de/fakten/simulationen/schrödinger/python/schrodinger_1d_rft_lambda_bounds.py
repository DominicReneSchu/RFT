...
def main() -> int:
    ...
    # ─── Header ───────────────────────────────────────────────────────
    print("=" * 74)
    print("  Theoretische Erwartung für λ (RFT-Kopplungsparameter)")
    print("  Frage: Welche Größenordnung hat λ?")
    print("  System: ⁸⁷Rb in harmonischer Falle")
    print("=" * 74)
...
def _plot_lambda_landscape(
    ...
    # Experimentelle Reichweite markieren
