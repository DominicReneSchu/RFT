"""
Gekoppelte Oszillatoren — Minimalbeispiel

Standalone-Skript zur schnellen Überprüfung der ODE-Lösung
ohne interaktive Slider. Nutzt feste Parameter.
...
plt.legend()
plt.title(f'Gekoppelte Oszillatoren (ε = {eps:.4f}, α = {alpha})')
