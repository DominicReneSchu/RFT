...
| # | Dokument | Axiome | Beschreibung |
|---|----------|--------|-------------|
| 1 | [Gesellschaftliche Analyse](fakten/docs/analysetools/gesellschaftliche_analyse.md) | A1–A7 | RFT-Analyseinstrument für gesellschaftliche Zusammenhänge – KI-Kontext-Prompt zur Mustererkennung in Nachrichtenmeldungen; Fassung 2.9: §3.8.0 prähistorischer Zyklus, §3.9–§3.10 hermeneutische Grundlegung, §4.4 Fragmentierungsdynamik |
