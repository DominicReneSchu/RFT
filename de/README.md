...
> **Hinweis:** Die folgenden Abschnitte entfalten die physikalische Struktur des Universums als kohärentes Resonanzfeld. Sie gehen über den axiomatischen Kern hinaus und sind als weiterführende Interpretation innerhalb des physikalisch ableitbaren Rahmens zu verstehen.
> 
...
| 6 | [AP6 — Kosmische Expansion als Phaseneffekt](fakten/theorie/rt42_ap6_kosmische_expansion_phaseneffekt.md) | A1, A4, A5, A8 | Hypothese bestätigt: ȧ/a = H₀·cos(Δφ/2) vollständig aus A1–A8 hergeleitet. Szenario A (Δφ = const): de-Sitter-Fixpunkt und verallg. de Sitter. Szenario B (β > 0): Slow-roll-Inflation; n_s ∈ [0,97, 0,99] Planck-konsistent. Szenario C (β < 0): beschleunigte Expansion; erklärt DESI-DR1-Signal (w_a < 0). Zeitlich variierendes k₀(t): dynamisches Λ_eff(t). Drei neue Falsifikationskriterien (F6–F8) — **✅ RT-42 AP6 abgeschlossen (Sep 2026)** |
